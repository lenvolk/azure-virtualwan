...
az account set --name LabSub
az account show  (to validate)
az logout
az account clear
...
```bash
#!/bin/bash
# Source: https://github.com/lenvolk/azure-virtualwan/tree/main/any-to-any
...
# Associated NSG to the VNET subnets (Spokes and Branches) HAS to be run from cloudshell
